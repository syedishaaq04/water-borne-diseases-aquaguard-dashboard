...
// Error fallback component same as before
const ErrorFallback: React.FC<{ error: Error; resetErrorBoundary: () => void }> = ({
  ...
  <div className="min-h-screen flex items-center justify-center bg-dashboard-background">
    <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
      ...
      <h2 className="text-lg font-semibold text-center text-dashboard-text mb-2">System Error Detected</h2>
      ...
      <details className="mb-4">
        <summary className="text-xs text-dashboard-muted cursor-pointer hover:text-dashboard-text">Technical Details</summary>
        <pre className="text-xs bg-gray-100 p-2 rounded mt-2 overflow-auto">{error.message}</pre>
      </details>
            ...
            <Route
              ...
              element={
                <div className="text-center py-12">
                  <h2 className="text-2xl font-bold text-dashboard-text mb-4">Page Not Found</h2>
                  <p className="text-dashboard-muted mb-8">The requested page could not be found.</p>
